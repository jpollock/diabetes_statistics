...
# Konrad Pagacz, MD (contact: konrad.pagacz@umed.lodz.pl; Department of Biostatistics and Translational Medicine, Medical University of Lodz, Poland)
# https://git.konsta.com.pl/ZBiMT/GlyculatorApp
...
Calculate1 = R6Class ('Calculate1',
                      ...
                      private = list (
                        ...
                        calculateAUC = function (df, name = "", interval = private$Measurement$interval) {
                          ...
                          AUC = MESS::auc(x = x, y = Glucose, type = "linear")/(length(Glucose))
                          ...
                          AUC_180 = MESS::auc(x = x, y = Glucose_180, type = "linear")/(length(Glucose))
                          ...
                          AUC_250 = MESS::auc(x = x, y = Glucose_250, type = "linear")/(length(Glucose))
                          ...
                          AUC_54 = 1 - (MESS::auc(x=x, y = Glucose_54, type='linear')/MESS::auc(x=x, y = rep(54, length(Glucose_54), type = 'linear')))
                          ...
                          AUC_70 = 1 - (MESS::auc(x=x, y = Glucose_70, type='linear')/MESS::auc(x=x, y = rep(70, length(Glucose_70), type = 'linear')))
